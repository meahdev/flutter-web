...
class _MaintenanceState extends State<Maintenance> {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      FxBox.w6,
                      _container(Icons.timer, "WHAT IS THE DOWNTIME?",
                          "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical.", "",),
                      FxBox.w6,
                      _container(Icons.email, "DO YOU NEED SUPPORT?",
        ...
        child: Column(
          children: [
            ...
            _containermobile(
              ...
              "There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.","  ",),
            FxBox.h20,
            _containermobile(Icons.timer, "WHAT IS THE DOWNTIME?",
              "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical.", "",),
            FxBox.h20,
            _containermobile(Icons.email, "DO YOU NEED SUPPORT?",
                "If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embar..","no-reply@domain.com")
          ],
        ),
      ),
  ...
  Widget _container(IconData? icon, String smallText, String paragraph,
      String email) {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
             ...
             email.isNotEmpty ?  GestureDetector(
                 onTap: () async{
                 ...
                 child: Align(
                     ...
                     child: Text('${email}',style: const TextStyle(color: Colors.indigo,fontWeight: FontWeight.bold),))) : const SizedBox.shrink(),
            ],
          ),
        ),
      ),
  ...
  Widget _containermobile(IconData? icon, String smallText, String paragraph,
      String email) {
    TextStyle style = const TextStyle(
        color: Color(0XFF5B626B), fontWeight: FontWeight.bold, fontSize: 15);
    return SizedBox(
