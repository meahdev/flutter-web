...
class AppRouter extends _i50.RootStackRouter {
  ...
  final Map<String, _i50.PageFactory> pagesMap = {
    ...
    FBadge.name: (routeData) {
      return _i50.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i20.FBadge(),
      );
    },
...
/// generated route for
/// [_i1.FMenuBar]
class FMenuBar extends _i50.PageRouteInfo<void> {
  const FMenuBar({List<_i50.PageRouteInfo>? children})
      : super(
          FMenuBar.name,
          path: '/',
...
/// generated route for
/// [_i20.FBadge]
class FBadge extends _i50.PageRouteInfo<void> {
  const FBadge()
      : super(
          FBadge.name,
          path: 'badge',
  ...
  static const String name = 'FBadge';
}
