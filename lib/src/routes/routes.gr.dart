...
class AppRouter extends _i16.RootStackRouter {
  ...
  List<_i16.RouteConfig> get routes => [
        _i16.RouteConfig(MenuBar.name, path: '/', children: [
          _i16.RouteConfig('#redirect',
              path: '',
              parent: MenuBar.name,
              redirectTo: 'dashboard',
              fullMatch: true),
          _i16.RouteConfig(TestWidget.name,
              path: 'dashboard', parent: MenuBar.name),
          _i16.RouteConfig(Toast.name, path: 'toast', parent: MenuBar.name),
          _i16.RouteConfig(Button.name, path: 'button', parent: MenuBar.name),
          _i16.RouteConfig(Rating.name, path: 'rating', parent: MenuBar.name),
          _i16.RouteConfig(Badge.name, path: 'badge', parent: MenuBar.name),
          _i16.RouteConfig(CupertinoIcon.name,
              path: 'cupertino-icon', parent: MenuBar.name)
        ]),
        _i16.RouteConfig(LoginOne.name, path: 'login-one'),
        _i16.RouteConfig(LoginTwo.name, path: 'login-two'),
        _i16.RouteConfig(RegisterOne.name, path: 'register-one'),
        _i16.RouteConfig(RegisterTwo.name, path: 'register-two'),
        _i16.RouteConfig(RecoverPasswordOne.name, path: 'recover-password-one'),
        _i16.RouteConfig(RecoverPasswordTwo.name, path: 'recover-password-two'),
        _i16.RouteConfig(LockScreenOne.name, path: 'lock-screen-one'),
        _i16.RouteConfig(LockScreenTwo.name, path: 'lock-screen-two')
      ];
}

/// generated route for
/// [_i1.MenuBar]
class MenuBar extends _i16.PageRouteInfo<void> {
  const MenuBar({List<_i16.PageRouteInfo>? children})
...
/// generated route for
/// [_i2.LoginOne]
class LoginOne extends _i16.PageRouteInfo<void> {
...
/// generated route for
/// [_i3.LoginTwo]
class LoginTwo extends _i16.PageRouteInfo<void> {
...
/// generated route for
/// [_i4.RegisterOne]
class RegisterOne extends _i16.PageRouteInfo<void> {
...
/// generated route for
/// [_i5.RegisterTwo]
class RegisterTwo extends _i16.PageRouteInfo<void> {
...
class RecoverPasswordOne extends _i16.PageRouteInfo<void> {
...
class RecoverPasswordTwo extends _i16.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.LockScreenOne]
class LockScreenOne extends _i16.PageRouteInfo<void> {
...
/// generated route for
/// [_i9.LockScreenTwo]
class LockScreenTwo extends _i16.PageRouteInfo<void> {
...
/// generated route for
/// [_i10.TestWidget]
class TestWidget extends _i16.PageRouteInfo<void> {
...
/// generated route for
/// [_i11.Toast]
class Toast extends _i16.PageRouteInfo<void> {
...
/// generated route for
/// [_i12.Button]
class Button extends _i16.PageRouteInfo<void> {
...
/// generated route for
/// [_i14.Badge]
class Badge extends _i16.PageRouteInfo<void> {
...
/// generated route for
/// [_i15.CupertinoIcon]
class CupertinoIcon extends _i16.PageRouteInfo<void> {
