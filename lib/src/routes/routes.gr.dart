...
class AppRouter extends _i24.RootStackRouter {
  ...
  List<_i24.RouteConfig> get routes => [
        _i24.RouteConfig(MenuBar.name, path: '/', children: [
          _i24.RouteConfig('#redirect',
              path: '',
              parent: MenuBar.name,
              redirectTo: 'loaders',
              fullMatch: true),
          _i24.RouteConfig(Dashboard.name,
              path: 'dashboard', parent: MenuBar.name),
          _i24.RouteConfig(Toast.name, path: 'toast', parent: MenuBar.name),
          _i24.RouteConfig(Button.name, path: 'button', parent: MenuBar.name),
          _i24.RouteConfig(Rating.name, path: 'rating', parent: MenuBar.name),
          _i24.RouteConfig(Badge.name, path: 'badge', parent: MenuBar.name),
          _i24.RouteConfig(AlertDialogBox.name,
              path: 'alert-dialog', parent: MenuBar.name),
          _i24.RouteConfig(Modal.name, path: 'modal', parent: MenuBar.name),
          _i24.RouteConfig(BasicEmail.name,
              path: 'basic-action-email', parent: MenuBar.name),
          _i24.RouteConfig(AlertEmail.name,
              path: 'alert-email', parent: MenuBar.name),
          _i24.RouteConfig(BillingEmail.name,
              path: 'billing-email', parent: MenuBar.name),
          _i24.RouteConfig(Loaders.name, path: 'loaders', parent: MenuBar.name),
          _i24.RouteConfig(MorrisChart.name,
              path: 'morris-chart', parent: MenuBar.name),
          _i24.RouteConfig(ChartListChart.name,
              path: 'chartlist-chart', parent: MenuBar.name),
          _i24.RouteConfig(ChartJsChart.name,
              path: 'chartjs-chart', parent: MenuBar.name)
        ]),
        _i24.RouteConfig(LoginOne.name, path: '/login-one'),
        _i24.RouteConfig(LoginTwo.name, path: '/login-two'),
        _i24.RouteConfig(RegisterOne.name, path: '/register-one'),
        _i24.RouteConfig(RegisterTwo.name, path: '/register-two'),
        _i24.RouteConfig(RecoverPasswordOne.name, path: '/recover-password'),
        _i24.RouteConfig(RecoverPasswordTwo.name,
            path: '/recover-password-two'),
        _i24.RouteConfig(LockScreenOne.name, path: '/lock-screen-one'),
        _i24.RouteConfig(LockScreenTwo.name, path: '/lock-screen-two')
      ];
}

/// generated route for
/// [_i1.MenuBar]
class MenuBar extends _i24.PageRouteInfo<void> {
  const MenuBar({List<_i24.PageRouteInfo>? children})
...
/// generated route for
/// [_i2.LoginOne]
class LoginOne extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i3.LoginTwo]
class LoginTwo extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i4.RegisterOne]
class RegisterOne extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i5.RegisterTwo]
class RegisterTwo extends _i24.PageRouteInfo<void> {
...
class RecoverPasswordOne extends _i24.PageRouteInfo<void> {
...
class RecoverPasswordTwo extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.LockScreenOne]
class LockScreenOne extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i9.LockScreenTwo]
class LockScreenTwo extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i11.Toast]
class Toast extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i12.Button]
class Button extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i13.Rating]
class Rating extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i14.Badge]
class Badge extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i15.AlertDialogBox]
class AlertDialogBox extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i16.Modal]
class Modal extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i17.BasicEmail]
class BasicEmail extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i18.AlertEmail]
class AlertEmail extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i19.BillingEmail]
class BillingEmail extends _i24.PageRouteInfo<void> {
...
/// generated route for
/// [_i20.Loaders]
class Loaders extends _i24.PageRouteInfo<void> {
