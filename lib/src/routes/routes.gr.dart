...
class AppRouter extends _i71.RootStackRouter {
  AppRouter([_i72.GlobalKey<_i72.NavigatorState>? navigatorKey])
      : super(navigatorKey);

  @override
  final Map<String, _i71.PageFactory> pagesMap = {
    FMenuBar.name: (routeData) {
      return _i71.MaterialPageX<dynamic>(
        routeData: routeData,
  ...
  @override
  List<_i71.RouteConfig> get routes => [
        _i71.RouteConfig(
          FMenuBar.name,
          path: '/',
          children: [
...
/// generated route for
/// [_i1.FMenuBar]
class FMenuBar extends _i71.PageRouteInfo<void> {
  const FMenuBar({List<_i71.PageRouteInfo>? children})
      : super(
          FMenuBar.name,
          path: '/',
...
/// generated route for
/// [_i2.LoginOne]
class LoginOne extends _i71.PageRouteInfo<void> {
  const LoginOne()
      : super(
          LoginOne.name,
          path: '/login-one',
...
/// generated route for
/// [_i3.LoginTwo]
class LoginTwo extends _i71.PageRouteInfo<void> {
  const LoginTwo()
      : super(
          LoginTwo.name,
          path: '/login-two',
...
/// generated route for
/// [_i4.RegisterOne]
class RegisterOne extends _i71.PageRouteInfo<void> {
  const RegisterOne()
      : super(
          RegisterOne.name,
          path: '/register-one',
...
/// generated route for
/// [_i5.RegisterTwo]
class RegisterTwo extends _i71.PageRouteInfo<void> {
  const RegisterTwo()
      : super(
          RegisterTwo.name,
          path: '/register-two',
...
class RecoverPasswordOne extends _i71.PageRouteInfo<void> {
...
class RecoverPasswordTwo extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.LockScreenOne]
class LockScreenOne extends _i71.PageRouteInfo<void> {
  const LockScreenOne()
      : super(
          LockScreenOne.name,
          path: '/lock-screen-one',
...
/// generated route for
/// [_i9.LockScreenTwo]
class LockScreenTwo extends _i71.PageRouteInfo<void> {
  const LockScreenTwo()
      : super(
          LockScreenTwo.name,
          path: '/lock-screen-two',
...
/// generated route for
/// [_i10.Error404]
class Error404 extends _i71.PageRouteInfo<void> {
  const Error404()
      : super(
          Error404.name,
          path: '/error-404',
...
/// generated route for
/// [_i11.Error500]
class Error500 extends _i71.PageRouteInfo<void> {
  const Error500()
      : super(
          Error500.name,
          path: '/error-500',
...
/// generated route for
/// [_i12.ComingSoon]
class ComingSoon extends _i71.PageRouteInfo<void> {
  const ComingSoon()
      : super(
          ComingSoon.name,
          path: '/coming-soon',
...
/// generated route for
/// [_i13.Maintenance]
class Maintenance extends _i71.PageRouteInfo<void> {
  const Maintenance()
      : super(
          Maintenance.name,
          path: '/maintenance',
...
/// generated route for
/// [_i14.Dashboard]
class Dashboard extends _i71.PageRouteInfo<void> {
  const Dashboard()
      : super(
          Dashboard.name,
          path: 'dashboard',
...
/// generated route for
/// [_i15.Calendar]
class Calendar extends _i71.PageRouteInfo<void> {
  const Calendar()
      : super(
          Calendar.name,
          path: 'calendar',
...
/// generated route for
/// [_i16.GoogleMaps]
class GoogleMaps extends _i71.PageRouteInfo<void> {
  const GoogleMaps()
      : super(
          GoogleMaps.name,
          path: 'map',
...
/// generated route for
/// [_i17.Toast]
class Toast extends _i71.PageRouteInfo<void> {
  const Toast()
      : super(
          Toast.name,
          path: 'toast',
...
/// generated route for
/// [_i18.Button]
class Button extends _i71.PageRouteInfo<void> {
  const Button()
      : super(
          Button.name,
          path: 'button-element',
...
/// generated route for
/// [_i19.Rating]
class Rating extends _i71.PageRouteInfo<void> {
  const Rating()
      : super(
          Rating.name,
          path: 'rating-bar',
...
/// generated route for
/// [_i20.CustomBadge]
class CustomBadge extends _i71.PageRouteInfo<void> {
  const CustomBadge()
      : super(
          CustomBadge.name,
          path: 'badge',
...
/// generated route for
/// [_i21.AlertDialogBox]
class AlertDialogBox extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i22.Modal]
class Modal extends _i71.PageRouteInfo<void> {
  const Modal()
      : super(
          Modal.name,
          path: 'modal',
...
/// generated route for
/// [_i23.Loaders]
class Loaders extends _i71.PageRouteInfo<void> {
  const Loaders()
      : super(
          Loaders.name,
          path: 'loaders',
...
/// generated route for
/// [_i24.TabScreen]
class TabScreen extends _i71.PageRouteInfo<void> {
  const TabScreen()
      : super(
          TabScreen.name,
          path: 'tabs',
...
/// generated route for
/// [_i25.BasicEmail]
class BasicEmail extends _i71.PageRouteInfo<void> {
  const BasicEmail()
      : super(
          BasicEmail.name,
          path: 'basic-action-email',
...
/// generated route for
/// [_i26.AlertEmail]
class AlertEmail extends _i71.PageRouteInfo<void> {
  const AlertEmail()
      : super(
          AlertEmail.name,
          path: 'alert-email',
...
/// generated route for
/// [_i27.BillingEmail]
class BillingEmail extends _i71.PageRouteInfo<void> {
  const BillingEmail()
      : super(
          BillingEmail.name,
          path: 'billing-email',
...
/// generated route for
/// [_i28.MorrisChart]
class MorrisChart extends _i71.PageRouteInfo<void> {
  const MorrisChart()
      : super(
          MorrisChart.name,
          path: 'morris-chart',
...
/// generated route for
/// [_i29.ChartListChart]
class ChartListChart extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i30.ChartJsChart]
class ChartJsChart extends _i71.PageRouteInfo<void> {
  const ChartJsChart()
      : super(
          ChartJsChart.name,
          path: 'chartjs-chart',
...
/// generated route for
/// [_i31.BasicTable]
class BasicTable extends _i71.PageRouteInfo<void> {
  const BasicTable()
      : super(
          BasicTable.name,
          path: 'basic-table',
...
/// generated route for
/// [_i32.Datatable]
class Datatable extends _i71.PageRouteInfo<void> {
  const Datatable()
      : super(
          Datatable.name,
          path: 'data-table',
...
class ResponsiveTable extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i34.EditableTable]
class EditableTable extends _i71.PageRouteInfo<void> {
  const EditableTable()
      : super(
          EditableTable.name,
          path: 'editable-table',
...
/// generated route for
/// [_i35.TimelineScreen]
class TimelineScreen extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i36.Pricing]
class Pricing extends _i71.PageRouteInfo<void> {
  const Pricing()
      : super(
          Pricing.name,
          path: 'pricing',
...
/// generated route for
/// [_i37.DirectoryPage]
class DirectoryRoute extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i38.FAQs]
class FAQs extends _i71.PageRouteInfo<void> {
  const FAQs()
      : super(
          FAQs.name,
          path: 'FAQs',
...
/// generated route for
/// [_i39.Invoice]
class Invoice extends _i71.PageRouteInfo<void> {
  const Invoice()
      : super(
          Invoice.name,
          path: 'invoice',
...
/// generated route for
/// [_i40.Gallery]
class Gallery extends _i71.PageRouteInfo<void> {
  const Gallery()
      : super(
          Gallery.name,
          path: 'gallery',
...
/// generated route for
/// [_i41.Carousel]
class Carousel extends _i71.PageRouteInfo<void> {
  const Carousel()
      : super(
          Carousel.name,
          path: 'carousel-slider',
...
/// generated route for
/// [_i42.ElementsForm]
class ElementsForm extends _i71.PageRouteInfo<void> {
  const ElementsForm()
      : super(
          ElementsForm.name,
          path: 'elements',
...
/// generated route for
/// [_i43.ValidationForm]
class ValidationForm extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i44.FileUploadForm]
class FileUploadForm extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i45.RepeaterForm]
class RepeaterForm extends _i71.PageRouteInfo<void> {
  const RepeaterForm()
      : super(
          RepeaterForm.name,
          path: 'repeater',
...
/// generated route for
/// [_i46.MaskForm]
class MaskForm extends _i71.PageRouteInfo<void> {
  const MaskForm()
      : super(
          MaskForm.name,
          path: 'mask',
...
/// generated route for
/// [_i47.WizardForm]
class WizardForm extends _i71.PageRouteInfo<void> {
  const WizardForm()
      : super(
          WizardForm.name,
          path: 'wizard',
...
/// generated route for
/// [_i48.VideoScreen]
class VideoScreen extends _i71.PageRouteInfo<void> {
  const VideoScreen()
      : super(
          VideoScreen.name,
          path: 'video-player',
...
/// generated route for
/// [_i49.UserProfile]
class UserProfile extends _i71.PageRouteInfo<void> {
  const UserProfile()
      : super(
          UserProfile.name,
          path: 'user-profile',
...
/// generated route for
/// [_i50.DragAndDrop]
class DragAndDrop extends _i71.PageRouteInfo<void> {
  const DragAndDrop()
      : super(
          DragAndDrop.name,
          path: 'drag-drop',
...
/// generated route for
/// [_i51.DatePicker]
class DatePicker extends _i71.PageRouteInfo<void> {
  const DatePicker()
      : super(
          DatePicker.name,
          path: 'date-picker',
...
/// generated route for
/// [_i52.ProductsScreen]
class ProductsScreen extends _i71.PageRouteInfo<void> {
...
class ProductDetailScreen extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i54.CategoryScreen]
class CategoryScreen extends _i71.PageRouteInfo<void> {
...
class SubCategoryScreen extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i56.VenderScreen]
class VenderScreen extends _i71.PageRouteInfo<void> {
  const VenderScreen()
      : super(
          VenderScreen.name,
          path: 'vender',
...
class VenderDetailScreen extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i58.CustomerScreen]
class CustomerScreen extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i59.PaymentScreen]
class PaymentScreen extends _i71.PageRouteInfo<void> {
  const PaymentScreen()
      : super(
          PaymentScreen.name,
          path: 'payment',
...
/// generated route for
/// [_i60.SuccessScreen]
class SuccessScreen extends _i71.PageRouteInfo<void> {
  const SuccessScreen()
      : super(
          SuccessScreen.name,
          path: 'payment/success',
...
class ReturnOrderScreen extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i62.OrderScreen]
class OrderScreen extends _i71.PageRouteInfo<void> {
  const OrderScreen()
      : super(
          OrderScreen.name,
          path: 'order',
...
class ReturnOrderInvoice extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i64.OrderInvoice]
class OrderInvoice extends _i71.PageRouteInfo<void> {
  const OrderInvoice()
      : super(
          OrderInvoice.name,
          path: 'order/order-invoice',
...
class SubScriptionScreen extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i66.CouponsScreen]
class CouponsScreen extends _i71.PageRouteInfo<void> {
  const CouponsScreen()
      : super(
          CouponsScreen.name,
          path: 'coupons',
...
class ReturnConditionScreen extends _i71.PageRouteInfo<void> {
...
class EcommerceDashboard extends _i71.PageRouteInfo<void> {
...
/// generated route for
/// [_i69.CartScreen]
class CartScreen extends _i71.PageRouteInfo<void> {
  const CartScreen()
      : super(
          CartScreen.name,
          path: 'cart',
...
/// generated route for
/// [_i70.ProductAdd]
class ProductAdd extends _i71.PageRouteInfo<void> {
  const ProductAdd()
      : super(
          ProductAdd.name,
          path: 'product-add',
